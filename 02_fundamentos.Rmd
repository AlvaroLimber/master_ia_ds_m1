...
## Conceptos y terminología
  ...
  - **Datasets:** Colección de datos, comparte el mismo conjunto de *atributos* o *propiedades*
    ...
    + *Unidades estadísticas:* Unidad de análisis, unidad de información
...
> Nota: Minería de datos KDD. Metadata los datos de los datos.
...
Determinar el tipo de análisis que se requiere en las siguientes solicitudes:
  ...
  - El INRA quiere conocer el efecto que tiene la titulación de tierras sobre los ingresos de los productores agropecuarios. **Diagnóstico**
  ...
  - UNFPA quiere saber el efecto que tuvo sus campañas de violencia que realizó en las universidades públicas del país. **Descriptiva, Diagnostica, predictivo** 
  - KAS quiere conocer los valores democráticos de los jóvenes **descriptiva**
  - OIM quiere saber que tipos de mensajes de empleo están vinculados a trata y tráfico para monitorear. **Predictiva**
...
> Actividad 2. Identifique el tipo de analítica de su respuesta en la actividad 1.

> Actividad 3. Identifique 5 KPI de su respuesta en la actividad 1.
